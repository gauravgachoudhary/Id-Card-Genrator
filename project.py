...
import qrcode
import json
os.system("title ID CARD Generator by Gaurav Choudhary")
...
message = "TATA CONSULTANCY SERVICE"
company=message
...
try :
    ...
    data1 = {"EmpId":EmpId, "Name":name,"Address":add,"Mobile No":phone,"Gender":Gen,}
    data=file['Emp']
    data.append(data1)
except :    
    data = {"Emp":[{"EmpId":EmpId, "Name":name,"Address":add,"Mobile No":phone,"Gender":Gen,}]}

file1 = open("data.json","w",encoding="utf-8")
